    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="bg-white px-8 pt-10 pb-6 text-center">
                <h2 class="text-3xl font-bold text-gray-800 tracking-tight">Atur Ulang</h2>
                <p class="text-gray-500 mt-2 text-sm">Silakan masukkan password baru kamu di bawah ini.</p>
            </div>
